            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    <flux:select label="Tipo de Movimiento" required wire:model="form.tipo_movimiento_id"
                        ...
                        <option value="">
                            {{ $tipoFlujoSeleccionado ? 'Seleccionar tipo...' : 'Seleccione primero ingreso o egreso' }}
                        </option>
                ...
                {{-- Monto --}}
                <div>
                    <flux:input type="number" step="0.01" min="0" label="Monto" prefix="S/" required
                        wire:model="form.monto" placeholder="0.00" />
                </div>
