...
class GestionNegocios extends Component
{
    ...
    protected $rules = [
        ...
        'certificado' => 'nullable|file|mimes:p12,pfx|max:2048',
    ...
    {
        $this->reset([
            'negocio', 'nombre_legal', 'ruc', 'direccion', 'tipo_negocio', 'usuario_sol', 
            'clave_sol', 'client_secret', 'modo', 'certificado', 'logo_factura',
            'certificado_actual', 'logo_actual', 'showForm', 'isEditing',
            'infoAdicionalCabecera', 'infoAdicionalCentro', 'infoAdicionalPie',
            'nuevaClave', 'nuevoValor', 'nuevaUbicacion', 'activeTab'
        ]);
    ...
    private function storeFile($file, $type)
    {
        ...
        // Guardar correctamente en el disco "public"
